...
if __name__ == "__main__":
    ...
    # construct the MLP
    # mlp_Xavier = MLP(784, [32, 16], 10,  init='xavier')
    mlp_Gauss = MLP(784, [32, 16], 10,  init='gauss')
    ...
    # train the MLP
    # mlp_Xavier.train(train_images, train_labels, val_images, val_labels, epochs=100, 
    #                     reg_method=reg_method, lambd=lambd,
    #                     learning_rate=0.0003, lr_decay=[False, 'non-linear', 5, 0.95],
    #                     batch_size=1, image_save_path="./Xavier_learning_curve.png")
    mlp_Gauss.train(train_images, train_labels, val_images, val_labels, epochs=100, 
                        reg_method=reg_method, lambd=lambd,
                        learning_rate=0.0003, lr_decay=[False, 'non-linear', 5, 0.95],
                        batch_size=1, image_save_path="./Gauss_learning_curve.png")

    # predictions on validation set
    # mlp_Xavier.evaluate_model(val_images, val_labels, reg_method, lambd)
    mlp_Gauss.evaluate_model(val_images, val_labels, reg_method, lambd)
