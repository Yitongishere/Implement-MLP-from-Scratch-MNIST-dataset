...
if __name__ == "__main__":
    ...
    # construct the MLP
    mlp_L1 = MLP(784, [32, 16], 10,  init='rand')
    mlp_L2 = MLP(784, [32, 16], 10,  init='rand')
    ...
    # train the MLP
    mlp_L1.train(train_images, train_labels, val_images, val_labels, epochs=10, 
                        reg_method=reg_method1, lambd=lambd,
                        learning_rate=0.0003, lr_decay=[False, 'linear', 5, 0.05],
                        batch_size=1, image_save_path="./L1_learning_curve.png")
    mlp_L2.train(train_images, train_labels, val_images, val_labels, epochs=10, 
                        reg_method=reg_method2, lambd=lambd,
                        learning_rate=0.0003, lr_decay=[False, 'non-linear', 5, 0.95],
                        batch_size=1, image_save_path="./L2_learning_curve.png")

    # predictions on validation set
    mlp_L1.evaluate_model(val_images, val_labels, reg_method1, lambd)
    mlp_L2.evaluate_model(val_images, val_labels, reg_method2, lambd)
